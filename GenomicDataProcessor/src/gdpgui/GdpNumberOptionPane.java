 ...
 * @version 0.1
 */
public final class GdpNumberOptionPane extends JDialog {
	...
	/**
	 * Private constructor. Used internally to create a GdpNumberOptionPane dialog. 
	 ...
	 */
	private GdpNumberOptionPane(Frame parentFrame, String aTitle, String aLabel, DecimalFormat df, double defaultValue, double min, double max) {
	 ...
	 */
	public static Number getValue(Frame parentFrame, String title, String label, DecimalFormat df, double min, double max, double defaultValue) {
		GdpNumberOptionPane NOP = new GdpNumberOptionPane(parentFrame, title, label, df, defaultValue, min, max);
		NOP.setVisible(true);	
		if(validated)
			return validValue;
		else
	 ...
	 * @return A number if OK has been pressed, otherwise null.
	 */
	public static Integer getValueWindow(Frame parentFrame, int defaultValue) {
		GdpNumberOptionPane NOP = new GdpNumberOptionPane(parentFrame, "Window size:", null, new DecimalFormat("0"), defaultValue, 1, 1000000);
		NOP.setVisible(true);
		if (validated)
